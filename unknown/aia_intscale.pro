...
case select of
0: return,bytscl((image*(2.99911/exptime)<1000))
1: return,bytscl((image*(1.00026/exptime)<2500))
...
6: return,(alog10((iamge*(2.99950/exptime)>120<6000)))
7: return,(alog10((image*(4.99801/exptime)>30<13000)))
8: return,(alog10((image*(4.99941/exptime)>50<2000)))
