...
outfile='fblos.fits'
ff = sock_find('http://sdowww.lmsal.com/sdomedia/SunInTime/',outfile,path='/'+yyyy+'/'+mm+'/'+dd)
...
sock_copy,remotefile,/clobber,err=err
...
if file_search(outfile) eq '' then begin & err=-1 & print,'FILE_SEARCH failed.' & return & endif
