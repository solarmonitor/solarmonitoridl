...
;			2014-09-22 - Eoin Carley (TCD): Clean up formatting and indentation. Added loop to close LUNs.
;
...
total_runtime = (anytim(completion_time, /utim) - anytim(sm_begin_time, /utim))/60.0 ;minutes
print,';------------------------------------------------------------------------------;'
