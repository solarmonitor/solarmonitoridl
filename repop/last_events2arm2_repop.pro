...
pro last_events2arm2_repop, date_struct, events
...
; Read the last_events web page.
  ...
  pingagain:
  sock_ping,'www.lmsal.com',status
  if status ne 1 then begin
  	print,'Ping WWW.LMSAL.COM unsuccessful. Trying again...' 
  	wait,30
  	goto,pingagain
  endif
  ...
  events_struct = get_gevloc_data('gev_'+strtrim(date_struct.date,2)+'*')
