...
pro ar_comb_repop, date_struct, srs_today, srs_yesterday, events, summary, no_region_today, no_region_yesterday
...
; Combine AR summary and events list for today and tomorrow separately
  ...
  ar_org_repop, date_struct, srs_today, events, concat1, no_region_today, /today, corrupt_srs
  if corrupt_srs eq 1 then begin & summary='No data' & return & endif
  ar_org_repop, date_struct, srs_yesterday, events, concat2, no_region_yesterday, /yesterday, corrupt_srs
  if corrupt_srs eq 1 then begin & summary='No data' & return & endif
