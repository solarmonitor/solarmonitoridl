...
pro ar_org_repop, date_struct, srs, events, summary, no_region, corrupt_srs, today = today, yesterday = yesterday
...
;check if the srs file is messed up
if (st( 0 ) + 2) gt (en( 0 ) - 1) then begin
	corrupt_srs=1
	summary='No data'
	return
endif
